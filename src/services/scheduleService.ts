...
export const scheduleService = {  // Get all upcoming sessions (public access)
  ...
  async getTodaySchedule(): Promise<ScheduleDay> {    try {
  ...
  async getWeeklySchedule(weekStart?: string): Promise<WeeklySchedule> {    try {
      const url = weekStart 
